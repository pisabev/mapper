...
void main() {
  ...
  setUp(() async {
    ...
    await connection.execute("INSERT INTO t (i, bi, bl, si, t, f, d, dt, ts, tsz, j, ba, u, dl) "
        ...
        "'{\"key\":\"value\"}', E'\\\\000', '00000000-0000-0000-0000-000000000000', 12.22)");
