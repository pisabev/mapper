...
abstract class _PostgreSQLConnectionState {
  ...
  _PostgreSQLConnectionState awake() => this;

  _PostgreSQLConnectionState onMessage(ServerMessage message) => this;
...
/// Socket connected, prior to any PostgreSQL handshaking - initiates
/// that handshaking
class _PostgreSQLConnectionStateSocketConnected
  ...
  _PostgreSQLConnectionState onMessage(ServerMessage message) {
    ...
    completer.completeError(new PostgreSQLException(
        'Unsupported authentication type ${authMessage.type}, '
        'closing connection.'));
